      ...
      <div className="relative z-10 py-6 md:py-12 px-4 md:px-12">
        <div className="max-w-[1400px] mx-auto flex flex-col items-end">
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-center justify-end w-full gap-8 lg:gap-16">
            ...
            <div className="w-full max-w-2xl space-y-6 md:space-y-8 bg-pink-50/90 backdrop-blur-xl p-6 md:p-12 rounded-3xl md:rounded-[2.5rem] shadow-2xl border border-white/60">
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] md:text-[10px] font-black text-[#D63384] uppercase tracking-widest">
                    Personalizado para você
                  </span>
                </div>

                {/* ✅ TÍTULO CORRIGIDO MOBILE */}
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[42px] font-serif text-[#D63384] italic tracking-tight leading-tight break-words">
                  Veja como sua foto fica linda!
                </h1>

                <p className="text-[#5D4037] text-sm md:text-lg leading-relaxed font-medium">
              ...
              <div className="flex flex-col gap-3 pt-2">
                ...
                <label className="cursor-pointer bg-[#D63384] hover:bg-[#B91C1C] text-white px-6 py-4 md:px-8 md:py-5 rounded-2xl md:rounded-full font-bold text-xs md:text-sm uppercase tracking-[2px] transition-all flex items-center justify-center gap-2 shadow-lg active:scale-95 w-full">
                  <Upload size={20} />
                ...
                {image && (
                  <a
                    ...
                    target="_blank"
                    className="bg-[#25D366] hover:bg-[#128C7E] text-white px-6 py-4 md:px-8 md:py-5 rounded-2xl md:rounded-full font-bold text-xs md:text-sm uppercase tracking-[2px] shadow-xl transition-all flex items-center justify-center gap-2 w-full"
                  >
